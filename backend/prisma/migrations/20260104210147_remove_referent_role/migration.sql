...
*/
-- Update existing REFERENT users to TEACHER before removing the enum value
UPDATE "User" SET role = 'TEACHER' WHERE role = 'REFERENT';

-- AlterEnum
BEGIN;
CREATE TYPE "Role_new" AS ENUM ('TEACHER', 'STUDENT', 'ADMIN');
