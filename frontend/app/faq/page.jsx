...
export default function Page() {
  const [selectedCategory, setSelectedCategory] = useState("Usage");
  const categories = [
    "Usage",
    "Fonctionnalités",
  ...
  return (
    <>
      <Header />
      <div className="justify-center items-center flex flex-col gap-4 text-center pt-42 px-8 pb-10 bg-[#F4F4F4] w-full">
        <h1 className="text-3xl font font-mochiy text-[#131316]">
        ...
        <div className="relative w-full max-w-md">
          ...
          />
          <BiSearch className="absolute right-3 top-7 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
        </div>
      </div>
      ...
      <main className="bg-white flex flex-col justify-center px-16 py-16">
        <section className="container mx-auto w-full max-w-[1368px]">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                <ul className="list-disc pl-5">
                  ...
                  <li>
                    Une matière est un enseignement associé à un intervenant.
                    Une même classe peut regrouper plusieurs matières.
                  </li>
                </ul>
              </FaqCard>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                <p>
                  Tous les retours sont centralisés dans un dashboard clair et
                ...
                <ul className="mt-3 list-disc pl-5">
                  ...
                  <li>
                    recevoir des alertes automatiques en cas de signaux faibles
                    (positifs ou négatifs) dans les retours.
                  </li>
                </ul>
              </FaqCard>
              ...
              <FaqCard question="Les retours sont-ils vraiment anonymes ?">
                <p>
                  Oui. Par défaut, tous les retours sont anonymes. Dans l’offre
                  Super Izzzi, l’étudiant peut toutefois choisir de lever
                  l’anonymat s’il le souhaite pour un message.
                </p>
              </FaqCard>
            </div>
          </div>
        ...
        <section className="container mx-auto mt-12 w-full max-w-[1368px]">
          ...
          <div className="overflow-x-auto -mx-4 px-4 pb-2 scrollbar-hide">
            <ul className="flex gap-3 mb-8 min-w-max md:flex-wrap md:min-w-0">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 mb-8">
            ...
            >
              <ul className="list-disc pl-5">
                <li>Une classe correspond à un groupe d’étudiants.</li>
                <li>
                  Une matière est un enseignement associé à un intervenant. Une
                  même classe peut regrouper plusieurs matières.
                </li>
              </ul>
            </FaqCard>
          </div>
